        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-3 col-md-3">
                    <div class="top-logo">
                        <a href="index..php"><img src="img/logos/logo.png" alt="logo"></a>
                    </div>
                </div>
                    ...
                    <div class="product-slider-box cds-2 clearfix mb-2">
                        <div class="product-img-slide">
                            <div class="slider-for2">
                                <img src="img/properties/properties-1.jpg" class="img-fluid w-100" alt="slider-photo">
                                <img src="img/properties/properties-2.jpg" class="img-fluid w-100" alt="slider-photo">
                                <img src="img/properties/properties-3.jpg" class="img-fluid w-100" alt="slider-photo">
                                <img src="img/properties/properties-4.jpg" class="img-fluid w-100" alt="slider-photo">
                                <img src="img/properties/properties-5.jpg" class="img-fluid w-100" alt="slider-photo">
                            </div>
                            <div class="slider-nav2">
                                <div class="thumb-slide"><img src="img/properties/properties-1.jpg" alt="small-photo">
                                </div>
                                <div class="thumb-slide"><img src="img/properties/properties-2.jpg" alt="small-photo">
                                </div>
                                <div class="thumb-slide"><img src="img/properties/properties-3.jpg" alt="small-photo">
                                </div>
                                <div class="thumb-slide"><img src="img/properties/properties-4.jpg" alt="small-photo">
                                </div>
                                <div class="thumb-slide"><img src="img/properties/properties-4.jpg" alt="small-photo">
                                </div>
                            </div>
                            ...
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="profile-tab" data-bs-toggle="tab"
                                        ...
                                        aria-selected="false">Condition</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="profile-tab4" data-bs-toggle="tab"
                                        data-bs-target="#profile4" type="button" role="tab" aria-controls="profile4"
                                        ...
                                        <div class="accordion-item">
                                            <div class="properties-description">
                                                ...
                                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas in
                                                    ...
                                                    lacus eu nunc porttitor, ut hendrerit arcu efficitur.</p>
                                                <br>
                                                <p class="mb-0">Nam mattis lobortis felis eu blandit. Morbi tellus
                                                    ligula, interdum sit amet ipsum et, viverra hendrerit lectus. Nunc
                                                    efficitur sem vel est laoreet, sed bibendum eros viverra. Vestibulum
                                                    finibus, ligula sed euismod tincidunt, lacus libero lobortis ligula,
                                                    sit amet molestie ipsum purus ut tortor. Nunc varius, dui et
                                                    sollicitudin facilisis, erat felis imperdiet felis, et iaculis dui
                                                    magna vitae diam. Donec mattis diam nisl, quis ullamcorper enim
                                                    malesuada non. Curabitur lobortis eu mauris nec vestibulum. Nam
                                                    efficitur, ex ac semper malesuada nisi odio consequat dui, hendrerit
                                                    vulputate odio dui vitae massa. Aliquam tortor urna, tincidunt</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="accordion accordion-flush" id="accordionFlushExample5">
                                        <div class="accordion-item">
                                            <div class="floor-plans">
                                                ...
                                                <img src="img/properties/floor-plans.png" alt="floor-plans"
                                                    class="img-fluid">
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="contact-form">
                            <form id="contact_form"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="send-btn">
                                            <button type="submit" class="button-md button-theme btn-3">Send
                                                Message</button>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="sidebar-widget popular-posts">
                            ...
                            <div class="d-flex mb-3 popular-posts-box">
                                <a class="pr-3" href="properties-details..php">
                                    <img src="img/properties/small-properties-2.jpg" alt="small-photo"
                            ...
                            <div class="d-flex mb-3 popular-posts-box">
                                <a class="pr-3" href="properties-details..php">
                                    <img src="img/properties/small-properties-1.jpg" alt="small-photo"
                                        class="flex-shrink-0 me-3">
                                </a>
                                <div class="detail align-self-center">
                                    <h4>
                            ...
                            <div class="d-flex popular-posts-box">
                                <a class="pr-3" href="properties-details..php">
                                    <img src="img/properties/small-properties-3.jpg" alt="small-photo"
                                        class="flex-shrink-0 me-3">
                                </a>
                                <div class="detail align-self-center">
                                    <h4>
