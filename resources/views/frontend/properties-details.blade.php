                ...
                <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="properties-slider-section mb-25 clearfix">
                        <div class="slider slider-for">
                            <div><img src="frontend/img/properties/properties-1.jpg" class="w-100 img-fluid" alt="photo"></div>
                            <div><img src="frontend/img/properties/properties-2.jpg" class="w-100 img-fluid" alt="photo"></div>
                            <div><img src="frontend/img/properties/properties-3.jpg" class="w-100 img-fluid" alt="photo"></div>
                            <div><img src="frontend/img/properties/properties-4.jpg" class="w-100 img-fluid" alt="photo"></div>
                            <div><img src="frontend/img/properties/properties-4.jpg" class="w-100 img-fluid" alt="photo"></div>
                        </div>
                        <div class="slider slider-nav">
                            <div><img src="frontend/img/properties/properties-1.jpg" class="img-fluid" alt="photo"></div>
                            <div><img src="frontend/img/properties/properties-2.jpg" class="img-fluid" alt="photo"></div>
                            <div><img src="frontend/img/properties/properties-3.jpg" class="img-fluid" alt="photo"></div>
                            <div><img src="frontend/img/properties/properties-4.jpg" class="img-fluid" alt="photo"></div>
                            <div><img src="frontend/img/properties/properties-5.jpg" class="img-fluid" alt="photo"></div>
                        </div>
                    </div>
                    ...
                    <div class="sidebar-widget">
                        ...
                        <div class="properties-description mb-30">
                            ...
                            <br>
                            <p>felis imperdiet felis, et iaculis dui magna vitae diam. Donec mattis diam nisl, quis
                                ullamcorper enim malesuada non. Curabitur lobortis eu mauris nec vestibulum. Nam
                                efficitur, ex ac semper malesuada nisi odio consequat dui, hendrerit vulputate odio dui
                            </p>
                            <p>Nam mattis lobortis felis eu blandit. Morbi tellus ligula, interdum sit amet ipsum et,
                                viverra hendrerit lectus. Nunc efficitur sem vel est laoreet, sed bibendum eros viverra.
                                Vestibulum finibus, ligula sed euismod tincidunt, lacus libero lobortis ligula, sit amet
                                molestie ipsum purus ut tortor. Nunc varius, dui et sollicitudin facilisis, erat felis
                                imperdiet felis, et iaculis dui magna vitae diam. Donec mattis diam nisl, quis
                                ullamcorper enim malesuada non. Curabitur lobortis eu mauris nec vestibulum. Nam
                                efficitur, ex ac semper malesuada nisi odio consequat dui, hendrerit vulputate odio dui
                            </p>
                        </div>
                        ...
                        <div class="properties-condition mb-20">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                    <ul class="condition">
                                        <li>
                                            <i class="flaticon-square-layouting-with-black-square-in-east-area"></i>4800
                                            sq ft
                                        </li>
                                        <li>
                    ...
                    <div class="floor-plans sidebar-widget">
                        ...
                        <img src="frontend/img/properties/floor-plans.png" alt="floor-plans" class="img-fluid">
                    </div>
                    <!-- Floor plans end -->
                ...
                <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="sidebar right">
                        ...
                        <div class="inside-properties sidebar-widget">
                            ...
                            <iframe class="modalIframe" src="https://www.youtube.com/embed/V7IrnC9MISU"
                            ...
                            <div class="contact-form">
                                <form
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="property-price" class="form-control" id="inputprice1"
                                            placeholder="$820.000">
                                    </div>
                                    <div class="form-group">
                                        <label for="inputinterest1" class="form-label">Interest Rate (%)</label>
                                        <input type="text" name="interest" class="form-control" id="inputinterest1"
                                            placeholder="15%">
                                    </div>
                                    <div class="form-group">
                                        <label for="inputmonths1" class="form-label">Period In Months</label>
                                        <input type="text" name="months" class="form-control" id="inputmonths1"
                                            placeholder="Period In Months">
                                    </div>
                                    <div class="form-group">
                                        <label for="inputpayment1" class="form-label">Down Payment</label>
                                        <input type="text" name="payment" class="form-control" id="inputpayment1"
                                            placeholder="$36,300">
                                    </div>
                                    <div class="form-group mb-0">
                                        <button type="submit" class="button-md button-theme btn-3 w-100">Search</button>
                        ...
                        <div class="sidebar-widget latest-tweet mb-30">
                            ...
                            <p>@Lorem ipsum dolor<a href="#">sit amet, consectetur</a> adipiscing elit. Aenean id
                                dignissim justo. Maecenas urna lacus, bibendum quis orci </p>
                        </div>
                        <!-- Latest tweet end -->
                    </div>
                    <!-- Sidebar end -->
                        ...
                        <div class="property-2">
                            <div class="property-inner">
                                ...
                                <div class="content">
                                    <!-- title -->
                                    <h4 class="title">
                                        <a href="properties-details..php">Family Villa</a>
                                    </h4>
                                    <!-- Property address -->
                                    <h3 class="property-address">
                                        <a href="properties-details..php">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="custom-slider slide-box-btn">
                        <div class="custom-box"><img src="frontend/img/brand/partner.png" alt="brand"></div>
                        <div class="custom-box"><img src="frontend/img/brand/partner-2.png" alt="brand"></div>
                        <div class="custom-box"><img src="frontend/img/brand/partner-3.png" alt="brand"></div>
                        <div class="custom-box"><img src="frontend/img/brand/partner-4.png" alt="brand"></div>
                        <div class="custom-box"><img src="frontend/img/brand/partner-5.png" alt="brand"></div>
                        <div class="custom-box"><img src="frontend/img/brand/partner.png" alt="brand"></div>
                        <div class="custom-box"><img src="frontend/img/brand/partner-2.png" alt="brand"></div>
                        <div class="custom-box"><img src="frontend/img/brand/partner-3.png" alt="brand"></div>
                        <div class="custom-box"><img src="frontend/img/brand/partner-4.png" alt="brand"></div>
