                ...
                <div class="col-lg-8 col-md-12 col-xs-12">
                        ...
                        <div class="row g-0">
                            <div class="col-lg-5 col-md-4 col-sm-5">
                                <h4>
                                    ...
                                    <span class="title">Agent Grid</span>
                                </h4>
                            </div>
                            <div class="col-lg-7 col-md-8 col-sm-7">
                                <div class="sorting-options advanced-search">
                                    ...
                                    <a href="agent-listing-row-sidebar..php" class="change-view-btn"><i
                                            class="fa fa-th-list"></i></a>
                                    <a href="agent-listing-grid-sidebar..php" class="change-view-btn active-view-btn"><i
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <div class="agent-1">
                                <div class="member-thumb">
                                    <img src="img/avatar/avatar-1.png" alt="agent-1" class="img-fluid">
                                </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <div class="agent-1">
                                <div class="member-thumb">
                                    <img src="img/avatar/avatar-2.png" alt="agent-1" class="img-fluid">
                                </div>
                                <div class="member-content-wrap">
                                    <div class="member-name-designation">
                                        <h4 class="member-name">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <div class="agent-1">
                                <div class="member-thumb">
                                    <img src="img/avatar/avatar-3.png" alt="agent-1" class="img-fluid">
                                </div>
                                <div class="member-content-wrap">
                                    <div class="member-name-designation">
                                        <h4 class="member-name">
