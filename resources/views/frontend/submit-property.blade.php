                ...
                <div class="col-md-12">
                    <div class="notification-box">
                        ...
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean ac tortor at tellus feugiat
                            congue quis ut nunc. Semper ac dolor vitae accumsan.</p>
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="submit-address">
                        <form method="GET">
                                ...
                                <div class="row">
                                    <div class="col-lg-4  col-md-6 col-sm-12">
                                        <div class="form-group">
                                            <label for="inputproperty-title1" class="form-label">Property Title</label>
                                            <input type="text" name="property-title" class="form-control"
                                                id="inputproperty-title1" placeholder="Property Title">
                                        </div>
                                    </div>
                                    <div class="col-lg-4  col-md-6 col-sm-12">
                                        <div class="form-group">
                                    ...
                                    <div class="col-lg-4  col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="price" class="form-control" id="inputprice1"
                                                placeholder="USD">
                                        </div>
                                    </div>
                                    <div class="col-lg-4  col-md-6 col-sm-12">
                                        <div class="form-group">
                                            <label for="inputname1" class="form-label">Area/Location</label>
                            ...
                            <div class="row mb-30 ">
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="email" name="address" class="form-control" id="inputaddress1"
                                            placeholder="Address">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="code" class="form-control" id="inputcode1"
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <label for="inputphone2" class="form-label">Phone (optional)</label>
                                        <input type="text" name="phone" class="form-control" id="inputphone2"
                                            placeholder="Phone">
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <a class="btn-2 btn-defaults" href="#">
                                        <span>Preview</span> <i class="arrow"></i>
                                    </a>
                                </div>
                            </div>
                        </form>
