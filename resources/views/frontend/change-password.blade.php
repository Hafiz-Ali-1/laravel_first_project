...
<body>
    ...
    <div class="content-area-6 change-password">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-8 col-md-12 col-sm-12">
                    <!-- My address start -->
                    <div class="my-address mb-30">
                        <div class="main-title-4">
                            <h1 class="mb-4"><span>Change</span> Password</h1>
                        </div>
                        <form
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" name="current-password" class="form-control" id="inputpassword1"
                                    placeholder="Current Password">
                            </div>
                            <div class="form-group">
                                <label for="inputpassword2" class="form-label">New Password</label>
                                <input type="password" name="new-password" class="form-control" id="inputpassword2"
                            ...
                            <a class="btn-2 btn-defaults" href="submit-property..php">
