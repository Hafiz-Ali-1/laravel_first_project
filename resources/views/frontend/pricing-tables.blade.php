            ...
            <div class="row">
                <div class="col-lg-4 col-md-12">
                    <div class="pricing-2">
                        ...
                        <div class="price-for-user">
                            <div class="price"><sup>$</sup><span class="dolar">54</span><small class="month">per
                                    month</small></div>
                        </div>
                        <div class="content">
                            <ul>
                ...
                <div class="col-lg-4 col-md-12">
                    <div class="pricing-2">
                        ...
                        <div class="price-for-user">
                            <div class="price"><sup>$</sup><span class="dolar active-c">35</span><small
                                    class="month">per month</small></div>
                        </div>
                        <div class="content">
                            <ul>
                                <li>20 Projects</li>
                ...
                <div class="col-lg-4 col-md-12">
                    <div class="pricing-2">
                        ...
                        <div class="price-for-user">
                            <div class="price"><sup>$</sup><span class="dolar">38</span><small class="month">per
                                    month</small></div>
                        </div>
                        <div class="content">
                            <ul>
