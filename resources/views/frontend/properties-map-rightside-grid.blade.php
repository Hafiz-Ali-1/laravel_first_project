...
<body>
    ...
    <div class="map-content content-area container-fluid">
        <div class="row">
            ...
            <div class="col-xl-6 col-lg-7 map-content-sidebar">
                <div class="title-area clearfix">
                    <h2 class="pull-left">Search</h2>
                </div>
                <div class="clearfix"></div>
                <div class="properties-map-search">
                    <div class="properties-map-search-content advanced-search">
                        <div class="row">
                ...
                <div class="title-area">
                    ...
                    <div class="pull-right btns-area">
                        <a href="properties-map-rightside-list..php" class="change-view-btn"><i
                                class="fa fa-th-list"></i></a>
                        <a href="properties-map-rightside-grid..php" class="change-view-btn active-view-btn"><i
                                class="fa fa-th-large"></i></a>
                    </div>
                    <div class="clearfix"></div>
                </div>
                <div class="fetching-properties row"></div>
            </div>
        </div>
    </div>
    <!-- Map content end -->
