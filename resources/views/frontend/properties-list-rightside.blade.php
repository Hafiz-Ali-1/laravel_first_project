...
<head>
    ...
    <script src="frontend/frontend/frontend/js/ie-emulation-modes-warning.js"></script>
...
<body>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-7 col-md-7 col-sm-7">
                                <div class="sorting-options advanced-search">
                                    ...
                                    <a href="properties-list-rightside..php" class="change-view-btn active-view-btn"><i
                                            class="fa fa-th-list"></i></a>
                                    <a href="properties-grid-rightside..php" class="change-view-btn"><i
                    ...
                    <div class="property row g-0 fp2 clearfix wow fadeInUp delay-03s">
                        <div class="col-lg-5 col-md-5 col-sm-12">
                            ...
                            <div class="property-img">
                                ...
                                <img src="frontend/img/properties/properties-list-1.jpg" alt="fp-list"
                    ...
                    <div class="property row g-0 fp2 clearfix wow fadeInUp delay-03s">
                        <div class="col-lg-5 col-md-5 col-sm-12">
                            <div class="property-img">
                                ...
                                <div class="property-tag button sale">For Sale</div>
                                <div class="property-price">$150,000</div>
                                <img src="frontend/img/properties/properties-list-2.jpg" alt="fp-list"
                                    class="img-responsive hp-1">
                                <div class="property-overlay">
                                    <a href="properties-details..php" class="overlay-link">
                                        <i class="fa fa-link"></i>
                    ...
                    <div class="property row g-0 fp2 clearfix wow fadeInUp delay-03s">
                        <div class="col-lg-5 col-md-5 col-sm-12">
                            <div class="property-img">
                                ...
                                <div class="property-tag button sale">For Sale</div>
                                <div class="property-price">$150,000</div>
                                <img src="frontend/img/properties/properties-list-3.jpg" alt="fp-list"
                                    class="frontend/img-responsive hp-1">
                                <div class="property-overlay">
                                    <a href="properties-details..php" class="overlay-link">
                                        <i class="fa fa-link"></i>
                                    </a>
                                    ...
                                    <div class="property-magnify-gallery">
                                        <a href="frontend/img/properties/properties-3.jpg" class="overlay-link">
                                            <i class="fa fa-expand"></i>
                                        </a>
                                        <a href="frontend/img/properties/properties-4.jpg" class="hidden"></a>
                                        <a href="frontend/img/properties/properties-3.jpg" class="hidden"></a>
                ...
                <div class="col-lg-4 col-md-12 col-xs-12">
                        ...
                        <form method="GET">
                            ...
                            <div class="range-slider">
                                ...
                                <div data-min="0" data-max="10000" data-unit="Sq ft" data-min-name="min_area"
                                    data-max-name="max_area" class="range-slider-ui ui-slider" aria-disabled="false">
                                </div>
                    ...
                    <div class="sidebar-widget latest-reviews mb-30">
                        ...
                        <div class="latest-reviews-box d-flex mb-4">
                            <a class="pr-3" href="#">
                                <img src="frontend/img/avatar/avatar-1.jpg" alt="avatar" class="flex-shrink-0 me-3">
                            </a>
                            <div class="detail">
                        ...
                        <div class="latest-reviews-box d-flex">
                            <a class="pr-3" href="#">
                                <img src="frontend/img/avatar/avatar-2.jpg" alt="avatar" class="flex-shrink-0 me-3">
                            </a>
                            <div class="detail">
    ...
    <script src="frontend/frontend/js/bootstrap-submenu.js"></script>
    <script src="frontend/frontend/js/rangeslider.js"></script>
    <script src="frontend/frontend/js/jquery.mb.YTPlayer.js"></script>
    <script src="frontend/frontend/js/wow.min.js"></script>
    <script src="frontend/frontend/js/bootstrap-select.min.js"></script>
    <script src="frontend/frontend/js/jquery.easing.1.3.js"></script>
    <script src="frontend/frontend/js/jquery.scrollUp.js"></script>
    <script src="frontend/frontend/js/jquery.mCustomScrollbar.concat.min.js"></script>
    <script src="frontend/frontend/js/leaflet.js"></script>
    <script src="frontend/frontend/js/leaflet-providers.js"></script>
    <script src="frontend/frontend/js/leaflet.markercluster.js"></script>
    <script src="frontend/frontend/js/dropzone.js"></script>
    <script src="frontend/frontend/js/jquery.filterizr.js"></script>
    <script src="frontend/frontend/js/jquery.magnific-popup.min.js"></script>
    <script src="frontend/frontend/js/slick.min.js"></script>
    <script src="frontend/frontend/js/maps.js"></script>
    <script src="frontend/frontend/js/sidebar.js"></script>
