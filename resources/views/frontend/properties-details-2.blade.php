            ...
            <div class="featured-slider row slide-box-btn slider"
                ...
                <div class="slide slide-box">
                    <div class="banner-img">
                        <img src="img/properties/properties-13.jpg" alt="banner" class="img-fluid bp">
                    </div>
                </div>
                <div class="slide slide-box">
                    <div class="banner-img">
                        <img src="img/properties/properties-14.jpg" alt="banner" class="img-fluid bp">
                    </div>
                </div>
                <div class="slide slide-box">
                    <div class="banner-img">
                        <img src="img/properties/properties-15.jpg" alt="banner" class="img-fluid bp">
                    </div>
                </div>
                <div class="slide slide-box">
                    <div class="banner-img">
                        <img src="img/properties/properties-16.jpg" alt="banner" class="img-fluid bp">
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-lg-7 col-md-12 text-end">
                        ...
                        <div class="cover-buttons">
                            <ul class="clearfix">
                                ...
                                <li><i class="flaticon-bathroom"></i> Beds 2</li>
                                <li><i class="flaticon-area"></i> SQ.FT 3500</li>
                                <li><i class="flaticon-car"></i> Garage 1</li>
                                <li><i class="flaticon-window"></i> Balcony 1</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                                        ...
                                        <div class="accordion-item">
                                            <div class="properties-description">
                                                ...
                                                <p>Nam mattis lobortis felis eu blandit. Morbi tellus ligula, interdum
                                                    ...
                                                    dui vitae massa. Aliquam tortor urna, tincidunt</p>
                ...
                <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="sidebar right">
                        ...
                        <div class="sidebar-widget contact-1 mortgage-calculator mb-30">
                            <div class="main-title-4">
