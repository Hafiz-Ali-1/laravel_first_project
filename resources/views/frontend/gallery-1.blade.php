...
<noscript><iframe src="https://www.googletagmanager.com/ns..php?id=GTM-TNL8QV6"
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="filtr-container">
                <div class="col-lg-4 col-md-4 col-sm-6 col-12  filtr-item" data-category="1, 2, 3">
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 col-12  filtr-item" data-category="1">
                    <div class="portfolio-item car-magnify-gallery">
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 col-12  filtr-item" data-category="2, 3">
                    <div class="portfolio-item car-magnify-gallery">
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 col-12  filtr-item" data-category="3, 4">
                    <div class="portfolio-item car-magnify-gallery">
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 col-12  filtr-item" data-category="4">
                    <div class="portfolio-item car-magnify-gallery">
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 col-12  filtr-item" data-category="1">
                    <div class="portfolio-item car-magnify-gallery">
                        <a href="img/properties/properties-4.jpg" title="Beautiful Single Home">
                            <img src="img/properties/properties-4.jpg" alt="properties-gallery" class="img-fluid">
                        </a>
                        <div class="portfolio-content">
                            <div class="portfolio-content-inner">
