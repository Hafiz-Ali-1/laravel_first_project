                ...
                <div class="col-lg-8 col-md-12 col-sm-12">
                        ...
                        <div class="blog-inner">
                            <div class="blog-overflow">
                                <div class="blog-photo">
                                    <img src="img/blog/blog-1.jpg" alt="blog-1" class="img-fluid w-100">
                                </div>
                            </div>
                            <div class="detail">
                                <h3>
                                    <a href="blog-single-sidebar-right..php">Two Extra Hours a Day!</a>
                                </h3>
                                <ul class="post-meta clearfix">
                                    ...
                                    <li>
                                        <i class="fa fa-calendar-check-o"></i> Sep 14, 2020
                                    </li>
                                    <li>
                    ...
                    <div class="blog-1">
                        <div class="blog-inner">
                            <div class="blog-overflow">
                                <div class="blog-photo">
                                    <img src="img/blog/blog-2.jpg" alt="blog-1" class="img-fluid w-100">
                                </div>
                            </div>
                            <div class="detail">
                                <h3>
                                    <a href="blog-single-sidebar-right..php">Selling Your Real House</a>
                                </h3>
                                <ul class="post-meta clearfix">
                                    <li>
                                        <i class="fa fa-user-o"></i> admin
                    ...
                    <div class="blog-1">
                        <div class="blog-inner">
                            <div class="blog-overflow">
                                <div class="blog-photo">
                                    <img src="img/blog/blog-3.jpg" alt="blog-1" class="img-fluid w-100">
                                </div>
                            </div>
                            <div class="detail">
                                <h3>
                                    <a href="blog-single-sidebar-right..php">Buying a Best House</a>
                                </h3>
                                <ul class="post-meta clearfix">
                                    <li>
                                        <i class="fa fa-user-o"></i> admin
                    ...
                    <div class="blog-1">
                        <div class="blog-inner">
                            ...
                            <div class="detail">
                                <h3>
                                    <a href="blog-single-sidebar-right..php">Why Live in New York</a>
                                </h3>
                                <ul class="post-meta clearfix">
                                    <li>
                                        <i class="fa fa-user-o"></i> admin
