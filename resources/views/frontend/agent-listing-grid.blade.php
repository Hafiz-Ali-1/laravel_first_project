                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-7 col-sm-7 col-xs-10 cod-pad">
                        <div class="sorting-options advanced-search">
                            ...
                            <a href="agent-listing-row..php" class="change-view-btn"><i class="fa fa-th-list"></i></a>
                            <a href="agent-listing-grid..php" class="change-view-btn active-view-btn"><i
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                    ...
                    <div class="agent-3">
                        ...
                        <div class="info">
                            <h4><a href="agent-single..php">Busel park</a></h4>
                            <p>Programmer</p>
                        </div>
                    </div>
                    <!-- Agent 3 end -->
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                    ...
                    <div class="agent-3">
                        ...
                        <div class="info">
                            <h4><a href="agent-single..php">Michelle Nelson</a></h4>
                            <p>Support Manager</p>
                        </div>
                    </div>
                    <!-- Agent 3 end -->
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                    ...
                    <div class="agent-3">
                        ...
                        <div class="info">
                            <h4><a href="agent-single..php">Karen Paran</a></h4>
                            <p>Web Developer</p>
                        </div>
                    </div>
                    <!-- Agent 3 end -->
