        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-12 col-sm-12">
                    ...
                    <div class="user-account-box mbb-50">
                        <div class="header clearfix">
                            <div class="edit-profile-photo">
                                <img src="img/avatar/avatar-3.jpg" alt="agent-1" class="img-fluid">
                        ...
                        <div class="content">
                            <ul>
                                ...
                                <li>
                                    <a href="favorited-properties..php" class="active">
                ...
                <div class="col-lg-8 col-md-12 col-sm-12">
                    <div class="main-title-4">
                        <h1 class="mb-4"><span>Favorited</span> properties</h1>
                    </div>
                    <!-- table start -->
                    <table class="manage-table responsive-table">
                        <tbody>
                            <tr class="d-flex mb-3">
                                ...
                                <td class="title-container pe-3 align-self-center">
                                    <div class="title">
                                        <h4><a href="#">Beautiful family home </a></h4>
                                        <p><i class="fa fa-map-marker"></i> 123 Kathal St. Tampa City, </p>
                                        <p class="table-property-price mb-0">$900 / monthly</p>
                                    </div>
                                </td>
                                <td class="expire-date pe-3 align-self-center">December 17 2021</td>
                                <td class="action align-self-center">
                            ...
                            <tr class="d-flex mb-3">
                                <td class="photo pe-3">
                                    <img src="img/properties/properties-2.jpg" alt="properties" class="img-fluid">
                                </td>
                                <td class="title-container pe-3 align-self-center">
                                    <div class="title">
                            ...
                            <tr class="d-flex mb-3">
                                <td class="photo pe-3">
                                    <img src="img/properties/properties-3.jpg" alt="properties" class="img-fluid">
                                </td>
                                <td class="title-container pe-3 align-self-center">
                                    <div class="title">
                                        <h4><a href="#">Sweet Family Home</a></h4>
                                        <p><i class="fa fa-map-marker"></i> 123 Kathal St. Tampa City, </p>
                                        <p class="table-property-price mb-0">$900 / monthly</p>
                                    </div>
                                </td>
                            ...
                            <tr class="d-flex mb-3">
                                <td class="photo pe-3">
                                    <img src="img/properties/properties-4.jpg" alt="properties" class="img-fluid">
                                </td>
                                <td class="title-container pe-3 align-self-center">
                                    <div class="title">
                                        <h4><a href="#">Big Head House</a></h4>
                                        <p><i class="fa fa-map-marker"></i> 123 Kathal St. Tampa City, </p>
                                        <p class="table-property-price mb-0">$900 / monthly</p>
                                    </div>
                                </td>
                            ...
                            <tr class="d-flex mb-3">
                                <td class="photo pe-3">
                                    <img src="img/properties/properties-5.jpg" alt="properties" class="img-fluid">
                                </td>
                                <td class="title-container pe-3 align-self-center">
                                    <div class="title">
                                        <h4><a href="#">Masons Villas</a></h4>
                                        <p><i class="fa fa-map-marker"></i> 123 Kathal St. Tampa City, </p>
                                        <p class="table-property-price mb-0">$900 / monthly</p>
                                    </div>
                                </td>
                            ...
                            <tr class="d-flex mb-30">
                                <td class="photo pe-3">
                                    <img src="img/properties/properties-6.jpg" alt="properties" class="img-fluid">
                                </td>
                                <td class="title-container pe-3 align-self-center">
                                    <div class="title">
                                        <h4><a href="#">Park Avenue</a></h4>
                                        <p><i class="fa fa-map-marker"></i> 123 Kathal St. Tampa City, </p>
                                        <p class="table-property-price mb-0">$900 / monthly</p>
                                    </div>
                                </td>
