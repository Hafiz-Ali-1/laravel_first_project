        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-12 col-sm-12">
                    ...
                    <div class="user-account-box mb-50">
                    ...
                    <div class="my-address">
                        ...
                        <form
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="your-name" class="form-control" id="inputname1"
                                    placeholder="John Antony">
                            </div>
                            <div class="form-group">
                                <label for="inputtitle1" class="form-label">Your Title</label>
                                <input type="text" name="your-title" class="form-control" id="inputtitle1"
                                    placeholder="Your Title">
                            </div>
                            <div class="form-group">
                                <label for="inputphone1" class="form-label">Phone Number</label>
                                <input type="text" name="your-title" class="form-control" id="inputphone1"
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="exampleFormControlTextarea1" rows="3"
                                    placeholder="Etiam luctus malesuada quam eu aliquet. Donec eget mollis tortor. Donec pellentesque eros a nisl euismod, ut congue orci ultricies. Fusce aliquet metus non arcu varius ullamcorper a sit amet nunc. Donec in lacus neque. Vivamus ullamcorper sed ligula vitae"></textarea>
                            </div>
