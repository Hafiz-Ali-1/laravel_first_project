        ...
        <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-7 col-sm-7">
                        <div class="sorting-options advanced-search">
                            ...
                            <a href="agent-listing-row-sidebar..php" class="change-view-btn active-view-btn"><i
                                    class="fa fa-th-list"></i></a>
                            <a href="agent-listing-grid-sidebar..php" class="change-view-btn"><i
            ...
            <div class="row">
                <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                    <!-- Agent box 2 start -->
                    <div class="row agent-2 a-three g-0 clearfix">
                        <div class="col-lg-4 col-md-4 col-sm-12">
                            <div class="photo">
                                <img src="img/team/team-2.jpg" alt="agent-2" class="img-fluid">
                            ...
                            <div class="detail">
                                ...
                                <div class="contact">
                                    <ul>
                                        ...
                                        <li>
                                            <strong>Web:</strong><a href="mailto:info@themevessel.com">
                                                info@themevessel2.com</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div class="row agent-2 a-three g-0 clearfix">
                        <div class="col-lg-4 col-md-4 col-sm-12">
                            <div class="photo">
                                <img src="img/team/team-1.jpg" alt="agent-2" class="img-fluid">
                                <ul class="social-list clearfix">
                                    <li><a href="#" class="facebook-bg"><i class="fa fa-facebook"></i></a></li>
                                    <li><a href="#" class="twitter-bg"><i class="fa fa-twitter"></i></a></li>
                                    <li><a href="#" class="google-bg"><i class="fa fa-google-plus"></i></a></li>
                        ...
                        <div class="col-lg-8 col-md-8 col-sm-12 align-self-center">
                            <div class="detail">
                                <h4>
                                    <a href="agent-single..php">David Jackson Roy</a>
                                </h4>
                ...
                <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <!-- Tags box start -->
                    <div class="sidebar-widget tags-box mb-30">
                        <div class="main-title-4">
