        ...
        <div class="container">
            <div class="row mb-40">
                <div class="col-md-12">
                    ...
                    <blockquote>Mauris aliquet ultricies ante, non faucibus ante gravida sed. Sed ultrices pellentesque
                        purus, vulputate volutpat ipsum hendrerit sed neque sed sapien rutrum laoreet justo ultrices. In
                        pellentesque lorem condimentum dui morbi pulvinar dui non quam pretium ut lacinia tortor. Mauris
                        aliquet ultricies ante, non faucibus ante gravida sed. Sed ultrices pellentesque purus,
                        vulputate volutpat ipsum hendrerit sed neque sed sapien rutrum laoreet justo ultrices. In
                        pellentesque lorem condimentum dui morbi pulvinar dui non quam pretium ut lacinia tortor.
                    </blockquote>
                </div>
            </div>
            <div class="row mb-40">
                <div class="col-md-6">
                    ...
                    <p>Maecenas dolor est, interdum a euismod eu, <a href="#" class="tooltip top">tooltip from top</a>
                        nisl. Nam sed iaculis massa. Sed nisl lectus, tempor sed euismod quis, sollicitudin est <a
                            href="#" class="tooltip right">tooltip from right</a> dignissim bibendum <a href="#"
                            class="tooltip left">tooltip from left</a> nam erat felis, commodo sed semper commodo vel
                        mauris <a href="#" class="tooltip bottom">tooltip from bottom</a> bibendum tempus.</p>
                </div>
                <div class="col-md-6">
                    <div class="main-title-4">
                    ...
                    <p>
                        Bootstrap requires a<code>containing element </code>to wrap site contents and house
                        ou<code> grid system.</code> You may choose one of two containers to use in your projects. Note
                        that, due to<code>padding and more,</code> neither container is nestable.
                    </p>
                </div>
            </div>
            <div class="row mb-40">
                <div class="col-md-12">
                    ...
                    <p>Etiam elit est, tincidunt non tincidunt <sup>This is sup element</sup> elit, sed do. Mauris
                        aliquet ultricies <sub>This is sub element</sub> volutpat ipsum hendrerit sed neque sed sapien
                        rutrum laoreet justo ut labolore magna aliqua. <del>This is deleted element</del> enim ad minim
                        veniam. Lorem ipsum dosectetur.<mark class="color"> Adipisicing elit sed do mark element</mark>
                        with “color” class, consectetur adipisicing. Lorem <dfn>dfn element here</dfn> ipsum dosectetur
                        tincidunt sit amet, <strong>strong text</strong>. Aliquam eu id lectus. Vestibulum ante ipsum
                        primis in faucibus orci luctus et ultrices posuere cubilia. Lorem ipsum dosectetur
                        <code>Some code text</code> velit sagittis, <abbr title="The abbr tag">abbreviation</abbr> elit
                        est <mark>highlighted text by using “mark” tag</mark>.
                    </p>
                </div>
            </div>
            <div class="row mb-40">
