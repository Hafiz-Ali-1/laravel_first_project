...
<body>
    ...
    <!-- Elements page start -->
    <div class="elements-page content-area-16">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                                ...
                                <div class="accordion accordion-flush" id="accordionFlushExample7">
                                    <div class="accordion-item">
                                        <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy
                                            nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wre
                                            eu feugiat nulla facilisis at nibh euismod tincidunt ut laoreet dolore magna
                                            aliquam erat volutpat. Ut wre eu feugiat nulla facilisis at vero eros et
                                            accumsan et iusto odio dignissim qui blandit. consectetuer adipiscing elit,
                                            sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat
                                            volutpat. Ut wre eu feugiat nulla facilisis at nibh euismod tincidunt ut
                                            laoreet dolore magna aliquam erat volutpat. Ut wre eu feugiat nulla
                                            facilisis at vero eros et accumsan et iusto odio dignissim qui blandit.</p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="active-items-box mb-50">
                        ...
                        <div class="list-group">
                            <button type="button" class="list-group-item list-group-item-action active bg-active"
                                aria-current="true">
                                The current button
                            </button>
                                ...
                                <div id="flush-collapseOne" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body">
                                        <div class="p-text">
                                            ...
                                            tincidunt aliquam. Aliquam gravida massa at sem vulputate interdum et vel
                                            eros. Maecenas eros enim, tincidunt vel turpis vel, dapibus tempus nulla.
                                            Donec vel nulla dui. Pellentesque sed ante sed ligula hendrerit condimentum.
                                            Suspendisse rhoncus fringilla ipsum quis porta. Morbi tincidunt viverra
                                            pharetra. Vestibulum vel mauris et odio lobortis laoreet eget eu magna.
                                            Proin mauris erat, luctus at nulla ut, lobortis mattis magna. Morbi a arcu
                                            lacus. Maecenas tristique velit vitae nisi consectetur, in mattis diam
                                            sodales. Mauris sagittis sem mattis justo bibendum, a eleifend dolor
                                            facilisis. Mauris nec pharetra tortor, ac aliquam felis. Nunc pretium erat
                                            sed
                                        </div>
                                    </div>
                                </div>
