...
use App\Http\Controllers\frontend\AgentSingleController;
use App\Http\Controllers\frontend\BeautifulSingleHomeController;
use App\Http\Controllers\frontend\BlogController;
use App\Http\Controllers\frontend\ContactController;
use App\Http\Controllers\frontend\HomeController;
use App\Http\Controllers\frontend\LoginController;
use App\Http\Controllers\frontend\ModernFamilyController;
use App\Http\Controllers\frontend\PropertiesDetailsController;
use App\Http\Controllers\frontend\PropertiesListingController;
...
Route::get('/propertieslisting',[PropertiesListingController::class,'index']);
Route::get('/propertiesdetails',[PropertiesDetailsController::class,'index']);
Route::get('/login',[LoginController::class,'index']);
Route::post('/login',[LoginController::class,'store']);
Route::get('/signup',[SignupController::class,'index']);
Route::post('/signup',[SignupController::class,'store']);
Route::get('/modernfamily',[ModernFamilyController::class,'index']);
Route::get('/agentsingle',[AgentSingleController::class,'index']);
Route::get('/beautiful single home',[BeautifulSingleHomeController::class,'index']);
